...
public class SallowEqualsAndDeepEqualsExample {
    public static void main(String[] args) {
        ...
        System.out.println(Objects.equals(null, null));        //ture
        ...
        System.out.println(Arrays.deepEquals(arr1, arr2));          //ture
        System.out.println(Objects.deepEquals(null, arr2));       //flase
